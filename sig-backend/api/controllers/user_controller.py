...
class UserController:
    ...
    def add_user(request):
        ...
        if UserRepository.add_user(user):
            ...
            return abort(500, "Error al añadir el usuario")
    ...
    def delete_user(id):
        if UserRepository.delete_user(id):
            ...
            return abort(500, "Error al eliminar el usuario con id" + str(id))

    @staticmethod
    def get_user_by_id(id):
        user = UserRepository.get_user_by_id(id)
        return user.to_json() if user is not None else abort(404, "No existe un usuario con id: " + str(id))
